...
import {useGetJobApplicationQuery, useRejectJobApplicationMutation, useRateCandidateMutation} from "../../../redux_toolkit/employerApi.js";
  ...
  const handleReject = async (application) => {
    try {
      ...
      if (response?.success)
      {
        ...
        const updatedCandidatesData = candidatesData.filter(item => item.profile_id !== application.profile_id);
        ...
        <table className="table table-hover text-center">
          <thead>
            <tr>
              ...
              <th scope="col" style={{"textAlign": "left"}}>Vị trí ứng tuyển</th>
